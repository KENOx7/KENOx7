...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=500&lines=Hey%2C+I'm+Kanan;Junior+Full+Stack+Developer;Turning+coffee+into+code+%E2%98%95" alt="Typing SVG" />
...
kenan = {
    ...
    "summary":   "Building responsive web apps, REST APIs, auth systems "
                 "and database-driven applications. Mastered Front-End, "
                 "now leveling up in Back-End to become a well-rounded "
                 "Full-Stack Developer.",
    "education": [
        "Odlar Yurdu University — B.Sc. Information Technologies (GPA 95+, 2024–2028)",
        "Div Academy — Full Stack Web Development (2025–2026)"
    ],
    "passion":   ["backend systems", "API design", "problem solving", "game dev"],
    "fun_fact":  "Two-time ICPC Azerbaijan Regional Contest qualifier 🏆"
}
```
...
| 🥇 | Achievement | Result |
|---|---|---|
| 🤖 | **ICPC Azerbaijan Regional Contest 2025** | Qualified & competed as part of university team |
| 🎯 | **ICPC Azerbaijan Qualification 2025** | 71st / 157 teams → qualified for Regionals |
| 🤖 | **ICPC Azerbaijan Regional Contest 2024** | Qualified & competed as part of university team |
| 🎯 | **ICPC Azerbaijan Qualification 2024** | Successfully qualified for Regionals |
| 🔥 | **FireLand Hackathon** | 5th place / 60+ teams → Finals |
| 👾 | **OYU GameDev Bootcamp** | *Signal Lost* (Unity horror game) — ranked 7th |
| ⚡ | **Sumgayıt Cup 2** | 21st place overall |
| 🥇 | **Div Academy — Front-End Development** | First Degree Gold Diploma |
